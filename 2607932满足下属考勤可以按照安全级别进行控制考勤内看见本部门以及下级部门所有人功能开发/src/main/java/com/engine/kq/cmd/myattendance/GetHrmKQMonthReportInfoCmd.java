        ...
        try {
            ...
            while (recordSet.next()) {
                ...
                if (flowType == 0) {
                    ...
                    if (backDuration > 0) {
                        count = String.format("%.2f", duration) + "(" + (SystemEnv.getHtmlLabelName(24473, user.getLanguage()) + ":" + String.format("%.2f", backDuration)) + ")" + (durationrule == 3 ? SystemEnv.getHtmlLabelName(391, user.getLanguage()) : SystemEnv.getHtmlLabelName(1925, user.getLanguage()));
                    }
