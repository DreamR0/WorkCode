 ...
 * detail： 分享目录
 *  copy  自mobile/plugin/networkdisk/getDataList.jsp ---> Share
 */
public class CloudDiskShareFolderCmd extends AbstractCommonCommand<Map<String, Object>> {
    public CloudDiskShareFolderCmd(Map<String,Object> params, User user) {
        this.user = user;
        this.params = params;
    }
    ...
    public Map<String, Object> execute(CommandContext commandContext) {
        ...
        try {
            ...
            //记录异常日志
            writeLog("CloudDiskShareFolderCmd--->:"+ ex.getMessage());
        }
        return apidatas;
    }
}
