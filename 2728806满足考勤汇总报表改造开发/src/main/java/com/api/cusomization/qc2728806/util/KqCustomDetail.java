...
public class KqCustomDetail {

    //获取缺勤天数明细
    public Map<String, Object> getAbsenteeismDaysDetail(Map<String, Object> params, User user) {
        Map<String, Object> retmap = new HashMap<String, Object>();
        RecordSet rs = new RecordSet();
        String sql = "";
        try{
            String dialogTitle = "缺勤天数明细";
            ...
            String backFields = " a.id, b.resourceid,a.departmentid, a.lastname, a.workcode, a.status, a.dsporder, kqdate, serialid,serialid as serialid1, serialid as serialid2," +
                    " workbegintime,workendtime,signintime,signouttime, attendanceMins, signMins, absenteeismDays ";
            ...
            if (!"1".equals(isNoAccount)) {
                ...
                sqlWhere += " and absenteeismDays = 1 ";
            ...
            new BaseBean().writeLog("==zj==(sql)" + backFields + sqlFrom+sqlWhere);
            tableString=""+
     ...
     * @param params
     * @param user
     * @param detailType 0代表大夜班，1代表小夜班
     * @return
     */
    public Map<String, Object> getNightShiftBigDetail(Map<String, Object> params, User user,int detailType) {
        Map<String, Object> retmap = new HashMap<String, Object>();
        RecordSet rs = new RecordSet();
        String sql = "";
        try{
            String dialogTitle = detailType == 1?"小夜班明细":"大夜班明细";
            ...
            if (detailType == 0){
                sqlWhere += " and nightshiftBig = 1 ";
            }
            if (detailType == 1){
                sqlWhere += " and nightshiftSmall = 1 ";
            }
