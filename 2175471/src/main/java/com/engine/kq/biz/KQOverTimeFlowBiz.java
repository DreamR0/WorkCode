...
//        按照加班时长转调休的 时长设置
        ...
        //==zj==curKqOvertimeRulesDetailEntity
...
//        1-节假日、2-工作日、3-休息日
            if(changeType == 1){
              ...
              boolean isok = handle_changeType_2(initArrays, resourceid, splitDate, before_startTime, startTime, fromTime_index,kqTimesArrayComInfo,splitBean,
                  toTime_index,curKqOvertimeRulesDetailEntity);
...
//    }
  ...
  public boolean handle_changeType_2(int[] initArrays, String resourceid, String splitDate,
      ...
      KQTimesArrayComInfo kqTimesArrayComInfo, SplitBean splitBean, int toTime_index, KQOvertimeRulesDetailEntity curKqOvertimeRulesDetailEntity){
    ...
    if(cur_shiftInfoBean != null){
      ...
      if(real_workLongTimeIndex != null && !real_workLongTimeIndex.isEmpty()){
        ...
        int hasRestTime = curKqOvertimeRulesDetailEntity.getHasRestTime();  //获取“排除休息时间”开关状态
        new BaseBean().writeLog("==zj==(curKqOvertimeRulesDetailEntity)" + JSON.toJSONString(curKqOvertimeRulesDetailEntity));
