...
//		}
	...
	public static boolean canUseForWpsDocCenter(){
		return Config.isWpsDocCenterOpen(Config.OPEN_ALL);
	}

	public static boolean canUseForWpsDocCenter(String type){
		return Config.isWpsDocCenterOpen(type);
	}

	public static boolean canViewForWpsDocCenter(){
		return Config.isWpsDocCenterOpen(Config.OPEN_PREVIEW);
	}

	public static boolean canViewForWpsDocCenter(User user){
		return Config.alwaysUseDocCenter(user, Config.OPEN_PREVIEW);
	}

	public static boolean canFormatForWpsDocCenter(){
		return Config.isWpsDocCenterOpen(Config.OPEN_FORMAT);
	}

	public static boolean canEditForWpsDocCenter(){
		return Config.isWpsDocCenterOpen(Config.OPEN_EDIT);
	}

	public static boolean canEditForWpsDocCenter(User user){
		return Config.alwaysUseDocCenter(user, Config.OPEN_EDIT);
	}
