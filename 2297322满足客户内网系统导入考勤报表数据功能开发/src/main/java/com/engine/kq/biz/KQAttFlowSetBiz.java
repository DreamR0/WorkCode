...
//      }
  ...
  private String getFinishedByKQType(String kqtype, String fromDate, String toDate, User user,
    ...
    if(isLeave){
      ...
      //这里requestid换成requestidcustom
      fields = " distinct requestidcustom,resourceid as resourceId,subcompanyid,departmentid,newleavetype,fromdatedb as fromDate,fromtimedb as fromTime,todatedb as toDate,totimedb as toTime,durationdb,durationrule,SUM(duration) as duration,"
    ...
    //requestid换成requestidcustom
    baseSql += " GROUP BY requestidcustom,resourceid,subcompanyid,departmentid,newleavetype,fromdatedb,fromtimedb,todatedb,totimedb,durationdb,durationrule ";
