...
public class KQMyAttendanceServiceImpl extends Service implements KQMyAttendanceService {
    ...
    public Map<String, Object> getHrmKQReportInfo(Map<String, Object> params, User user) {
        ...
        //qc2474644 这里再带一个参数，用于判断是否是从我的考勤进入的
        KQBalanceOfLeaveBiz.setIsFromMyAttendance("1");
        new BaseBean().writeLog("==zj==(是否来自我的考勤静态)" + JSON.toJSONString(KQBalanceOfLeaveBiz.getIsFromMyAttendance()));
