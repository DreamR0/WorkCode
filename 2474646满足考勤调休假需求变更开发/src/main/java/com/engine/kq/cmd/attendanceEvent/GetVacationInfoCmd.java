...
public class GetVacationInfoCmd extends AbstractCommonCommand<Map<String, Object>> {
    ...
    String balanceOfLeave = "";
      ...
      if(balanceEnable){
        ...
        //qc2474646
        KQBalanceOfLeaveBiz.setIsFromMyAttendance("0");
        if(show_split_balance()){
          String vacationInfo = "";
          String allRestAmount = KQBalanceOfLeaveBiz.getRestAmount("" + resourceId, newLeaveType, fromDate, true);
          String currentRestAmount = KQBalanceOfLeaveBiz.getRestAmount("" + resourceId, newLeaveType, fromDate,false);
